...
const unhead_bOItf3aPynzSnGDmhcrPqy_PdK_HlMPWzm5l2V_cFpk = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-fPNlVoBS.mjs')
  }
];
...
const revive_payload_server_hNV_tvdK9OQl8ULMJdr_iBosBO1kgnngldZF6FRsNB4 = /* @__PURE__ */ defineNuxtPlugin({
...
const prerender_server_ynnXj36QfWUys84qChWwEUF0NU9iW5z_b0a2aehQ3q8 = /* @__PURE__ */ defineNuxtPlugin(async () => {
  {
    return;
  }
});
const plugins = [
  unhead_bOItf3aPynzSnGDmhcrPqy_PdK_HlMPWzm5l2V_cFpk,
  plugin,
  revive_payload_server_hNV_tvdK9OQl8ULMJdr_iBosBO1kgnngldZF6FRsNB4,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BzdStgJ0.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Clo-8tjr.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@4.1.3_@parcel+watcher@2.5.1_@types+node@24.8.1_@vue+compiler-sfc@3.5.22_db0@0.3.4__7ae13b9cb419a8db1369d88b6c957171/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@4.1.3_@parcel+watcher@2.5.1_@types+node@24.8.1_@vue+compiler-sfc@3.5.22_db0@0.3.4__7ae13b9cb419a8db1369d88b6c957171/node_modules/nuxt/dist/app/components/nuxt-root.vue");
